...
$articles = [
    ["name" => "APPLICAZIONI DI PSICOLOGIA DELLA COMUNICAZIONE", "docente" => "1014244 - PELLICANO ANTONIO"],
    ["name" => "APPLICAZIONI DI PSICOLOGIA DELLA COMUNICAZIONE", "docente" => "1014244 - FOTI FRANCESCA IRENE"],
    ["name" => "APPLICAZIONI DI PSICOLOGIA SCOLASTICA E DELLA FAMIGLIA", "docente" => "1014250 - COMMODARI ELENA"]
];
    ...
    <article>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_formazione1.php">
