...
$articles = [
    ["name" => "ANALISI E RICERCHE DI MERCATO (A - Z)", "docente" => "9794001 - LONGO MARIA CRISTINA"],
    ["name" => "ANTROPOLOGIA DEL PATRIMONIO E DEL TURISMO", "docente" => "9796708 - FALCONIERI IRENE"],
    ["name" => "ARCHEOLOGIA CLASSICA ED ATTIVITA' LABORATORIALI DI PROMOZIONE DI BENI ARCHEOLOGICI", "docente" => "9796803 - PAPPALARDO ELEONORA"]
];
    ...
    <article>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_formazione2.php">
