...
$articles = [
    ["name" => "FORMAZIONE, CULTURA, ISTITUZIONI E SOCIETÀ IN ETÀ MODERNA", "docente" => "9795301 - FRASCA ELENA"],
    ["name" => "LINGUA FRANCESE (A - Z)", "docente" => "1014513 - SALAFIA ZAIRA"],
    ["name" => "PROGETTAZIONE E VALUTAZIONE DI INTERVENTI FORMATIVI SUL TERRITORIO (A - Z)", "docente" => "1014229 - MULE' PAOLINA"]
];
    ...
    <article>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_formazione5.php">
