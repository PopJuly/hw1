...
$articles = [
    ["name" => "DIRITTO PUBBLICO DELLE FORMAZIONI SOCIALI E POLITICHE DI SOLIDARIETA' SOCIALE", "docente" => "9796697 - PATERNITI FRANCESCO"],
    ["name" => "EDUCAZIONE ALLA CORPOREITA' E METODOLOGIA DEL GIOCO - EDUCAZIONE ALLA CORPOREITA' NELLA PRIMA INFANZIA (A - L)", "docente" => "9794296 - PERCIAVALLE VALENTINA"],
    ["name" => "EDUCAZIONE ALLA CORPOREITA' E METODOLOGIA DEL GIOCO - EDUCAZIONE ALLA CORPOREITA' NELLA PRIMA INFANZIA (M - Z)", "docente" => "9794296 - PERCIAVALLE VALENTINA"]
];
    ...
    <article>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_formazione3.php">
