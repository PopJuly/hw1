...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Preparare e eseguire la query di selezione
   ...
   <script src="mhw4.js" defer></script>
    ...
    <select name='anno_accademico'>
      ...
      <section id="modal-view" class="hidden">
        ...
        <!-- ACCESSO UTENTI-->
        <p><strong>ACCESSO UTENTE</strong>
       <img class='info' src="https://www.location-etudiant.fr/_assets/detail_crous_resultat/div-aide/info_512pxGREY.png"/>
       <h1></h1></p>
       <form name='login' method='post'>
        NOME UTENTE <br><input type='text' name='nome_utente' required><?php if(isset($_POST["nome_utente"])){echo "value=".$_POST["nome_utente"];} ?><br><br>
        
        PASSWORD <br><input type='password' name='password_utente' required><?php if(isset($_POST["passowrd_utente"])){echo "value=".$_POST["password_utente"];} ?><br>
