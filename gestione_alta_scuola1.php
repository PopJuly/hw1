...
$articles = [
    ["name" => "Analisi del testo letterario contemporaneo e laboratorio di metodi critici digitali", "docente" => "9798169 - PALAZZOLO GIUSEPPE"]
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['aggiungi_insegnamento'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: gestione_alta_scuola.php");
    } else {
...
<body>
    ...
    <article>
        ...
        <section>
            ...
            <a class='insegnamenti' href='gestione_alta_scuola.php'>Risali di una categoria</a>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_alta_scuola1.php">
