...
$articles = [
    ["name" => "DIRITTO E ORGANIZZAZIONE DEI SERVIZI SANITARI E SCIENZE PSICOPEDAGOGICHE - MEDICINA DEL LAVORO", "docente" => "1005758 - LEDDA CATERINA"],
    ["name" => "INGLESE SCIENTIFICO", "docente" => "1005762 - DI FATTA ELEONORA"],
    ["name" => "SCIENZE BIOMEDICHE - CHIMICA GENERALE E INORGANICA", "docente" => "9795443 - FRAGALA' MARIA ELENA"]
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['aggiungi_insegnamento'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: gestione_mediche.php");
    } else {
...
<body>
    ...
    <article>
        ...
        <section>
            ...
            <a class='insegnamenti' href='gestione_mediche.php'>Risali di una categoria</a>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_mediche5.php">
