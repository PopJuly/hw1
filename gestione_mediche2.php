...
$articles = [
    ["name" => "AUDIOFONIATRIA E BIOINGEGNERIA - BIOINGEGNERIA ELETTRONICA E INFORMATICA", "docente" => "9796945 - BERITELLI FRANCESCO"],
    ["name" => "C.I. ANATOMIA E FISIOLOGIA - FISIOLOGIA", "docente" => "1003921 - CIRANNA Lucia"],
    ["name" => "C.I. ANATOMIA E FISIOLOGIA - INFORMATICA", "docente" => "1004027 - NICOLOSI ANGELO"]
];
    ...
    <article>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_mediche2.php">
