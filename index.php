  ...
  <html>
    ...
    <body>
      <article>
       ...
       <section>    
          <br><p><strong>ANNO ACCADEMICO </strong></p><h1></h1>
          ...
          <!-- Fine libreria per cercare libri-->

          <!-- Libreria per cercare album-->
          <form id="form_Spotify">
            Inserire il nome dell'album
          ...
          <section id="music-view">
            ...
            <!-- Fine libreria per cercare album-->

          
          </div><br><br>

          <button><a href='registrazione_utente.php'>REGISTRAZIONE</a></button><br><br>
          <button><a href='accesso_utente.php'>ACCESSO</a></button>
