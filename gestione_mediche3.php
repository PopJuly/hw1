...
$articles = [
    ["name" => "C.I. MEDICINA LEGALE E DEL LAVORO - MEDICINA DEL LAVORO", "docente" => "1003984 - LEDDA CATERINA"],
    ["name" => "ECONOMIA E DIRITTO - DIRITTO AMMINISTRATIVO", "docente" => "1016268 - PULVIRENTI MARCO GAETANO"],
    ["name" => "ECONOMIA E DIRITTO - ECONOMIA APPLICATA", "docente" => "1016268 - PLATANIA MARCO"]
];
    ...
    <article>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_mediche3.php">
