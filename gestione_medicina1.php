...
$articles = [
    ["name" => "CHIMICA DEGLI ALIMENTI E MERCEOLOGIA - CHIMICA DEGLI ALIMENTI", "docente" => "1015786 - ZERBO ANTONIO"]
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['aggiungi_insegnamento'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: gestione_medicina.php");
    } else {
...
<body>
    ...
    <article>
        ...
        <section>
            ...
            <a class='insegnamenti' href='gestione_medicina.php'>Risali di una categoria</a>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_medicina1.php">
