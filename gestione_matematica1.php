...
$articles = [
    ["name" => "ALGEBRA LINEARE E GEOMETRIA (A - E)", "docente" => "9795526 - STAGLIANO' GIOVANNI"]
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['aggiungi_insegnamento'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: gestione_matematica.php");
    } else {
...
<body>
    ...
    <article>
        ...
        <section>
            ...
            <a class='insegnamenti' href='gestione_matematica.php'>Risali di una categoria</a>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_matematica1.php">
