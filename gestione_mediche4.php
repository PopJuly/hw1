...
$articles = [
    ["name" => "SCIENZE BIOMEDICHE I - ANATOMIA UMANA", "docente" => "9795509 - LORETO CARLA AGATA"],
    ["name" => "SCIENZE BIOMEDICHE I - ISTOLOGIA", "docente" => "9795509 - CASTROGIOVANNI PAOLA"],
    ["name" => "SCIENZE INTERDISCIPLINARI I - IGIENE GENERALE ED APPLICATA", "docente" => "1013014 - CRISTALDI ANTONIO"]
];
    ...
    <article>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_mediche4.php">
