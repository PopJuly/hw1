...
$articles = [
    ["name" => "ANATOMIA E ISTOLOGIA UMANA - ANATOMIA UMANA (2)", "docente" => "1007108 - LUCA TONIA"],
    ["name" => "ANATOMIA E ISTOLOGIA UMANA - ANATOMIA UMANA (3)", "docente" => "1007108 - LUCA TONIA"],
    ["name" => "ANATOMIA E ISTOLOGIA UMANA - ISTOLOGIA UMANA (1)", "docente" => "1007108 - CASTROGIOVANNI PAOLA"]
];
    ...
    <article>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_mediche1.php">
