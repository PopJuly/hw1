...
$articles = [
    ["name" => "ANALISI FARMACEUTICA E NUTRACEUTICO-ALIMENTARE 1 (A - L)", "docente" => "9797594 - ROMEO GIUSEPPE"]
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['aggiungi_insegnamento'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: gestione_farmacia.php");
    } else {
...
<body>
    ...
    <article>
        ...
        <section>
            ...
            <a class='insegnamenti' href='gestione_farmacia.php'>Risali di una categoria</a>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_farmacia1.php">
