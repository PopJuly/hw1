...
$articles = [
    ["name" => "LABORATORIO DI PROGETTAZIONE URBANISTICA (M - Z)", "docente" => "1016435 - BARBAROSSA LUCA"]
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['aggiungi_insegnamento'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: gestione_architettura.php");
    } else {
...
<body>
    ...
    <article>
        ...
        <section>
            ...
            <a class='insegnamenti' href='gestione_architettura.php'>Risali di una categoria</a>
        ...
        <?php foreach ($articles as $article): ?>
            <li>
                ...
                <form method="POST" action="gestione_architettura1.php">
